...
class Wallet {
    ...
    splitUTXOS(utxos, keyPair, feeRate, utxoMinValue, utxoMaxValue, UTXO_MIN_VALUE //UTXO_MIN_VALUE
    ) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    optimizeWalletUTXOS(utxoMinValue, utxoMaxValue, utxoThreshold //UTXO_MIN_VALUE
    ) {
        return __awaiter(this, void 0, void 0, function* () {
            const utxos = yield this.getBitcoinjsUTXOs();
            const infoRes = yield this.insight.getBlockchainInfo();
