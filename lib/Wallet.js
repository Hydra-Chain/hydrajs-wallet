...
class Wallet {
    ...
    splitWalletUTXOS(utxoMinValue, utxoMaxValue, utxoThreshold // resultingUTXO
    ) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let txResponse = yield this.splitUTXOS(utxos, this.keyPair, feeRate, utxoMinValue || 0.001, utxoMaxValue || 200, utxoThreshold || 100);
